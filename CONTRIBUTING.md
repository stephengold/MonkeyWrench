# Contributing to MonkeyWrench

Thank you for your interest in contributing to MonkeyWrench!

The project isn't seeking financial contributions at this time.
However, there are other ways you can contribute to MonkeyWrench:

+ source code additions and improvements
  (to the library, sample applications, or build scripts),
...
[the README](https://github.com/stephengold/MonkeyWrench/blob/master/README.md),
...
MonkeyWrench has an established code style,
